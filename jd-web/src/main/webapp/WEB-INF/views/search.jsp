...
<title>${query} - 商品搜索 - 金条</title>
<meta name="Keywords" content="java,金条java" />
<meta name="description" content="在金条中找到了29910件java的类似商品，其中包含了“图书”，“电子书”，“教育音像”，“骑行运动”等类型的java的商品。" />
...
<li class="item-book" bookid="11078102">
	<div class="p-img">
		<a target="_blank" href="http://www.jd.com/items/${item.id }.html">
