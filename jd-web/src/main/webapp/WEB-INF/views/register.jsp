...
<div class="w" id="logo">
    <div>
    	<a href="http://www.jd.com/">
    		<img src="/images/jt-logo.png" alt="金条商城" width="170" height="60"/>
    	</a> <b></b>
    </div>
</div>
...
<div class="w" id="regist">
    <div class="mt">
        ...
        <span style="text-align: right">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a class="flk13"
                ...
                href="http://www.jd.com/user/login.html"
            ...
            <div class="form" onselectstart="return false;">
                ...
                <div id="o-password">
                    ...
                    <div class="fl item-ifo">
                        ...
                        <label for="protocol">我已阅读并同意<a href="#" class="blue" id="protocol">《金条用户注册协议》</a></label>
                        <span class="clr"></span>
